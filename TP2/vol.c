...
void read_bloc(unsigned int vol, unsigned int bloc, unsigned char * buf) {
	read_sector(convert_bloc_to_cyl(vol, bloc), convert_bloc_to_sec(vol, bloc), buf);
}

void read_bloc_n(unsigned int vol, unsigned int bloc, unsigned char * buf, unsigned int size) {
    read_sector(convert_bloc_to_cyl(vol, bloc), convert_bloc_to_sec(vol, bloc), buf, size);
}

void write_bloc(unsigned int vol, unsigned int bloc, const unsigned char * buf) {
	write_sector(convert_bloc_to_cyl(vol, bloc), convert_bloc_to_sec(vol, bloc), buf);
}

void write_bloc_n(unsigned int vol, unsigned int bloc, unsigned char * buf, unsigned int size) {
    write_sector(convert_bloc_to_cyl(vol, bloc), convert_bloc_to_sec(vol, bloc), buf, size);
}
